...
var CategoryWhere = struct {
	...
	CategoryID:  whereHelperstring{field: "\"categories\".\"category_id\""},
	Name:        whereHelperstring{field: "\"categories\".\"name\""},
	Description: whereHelperstring{field: "\"categories\".\"description\""},
	ImageURL:    whereHelperstring{field: "\"categories\".\"image_url\""},
...
func (r *categoryR) GetJewelleries() JewellerySlice {
	if r == nil {
		return nil
	}
...
var (
	categoryAllColumns            = []string{"category_id", "name", "description", "image_url", "created_at", "updated_at"}
	categoryColumnsWithoutDefault = []string{"name", "description", "image_url"}
	categoryColumnsWithDefault    = []string{"category_id", "created_at", "updated_at"}
...
func (o *Category) Jewelleries(mods ...qm.QueryMod) jewelleryQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"jewelleries\".\"category_id\"=?", o.CategoryID),
	)
...
func (categoryL) LoadJewelleries(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCategory interface{}, mods queries.Applicator) error {
	var slice []*Category
	var object *Category
	...
	query := NewQuery(
		qm.From(`jewelleries`),
		qm.WhereIn(`jewelleries.category_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Category) AddJewelleriesG(ctx context.Context, insert bool, related ...*Jewellery) error {
...
// of the category, optionally inserting them as new records.
// Appends related to o.R.Jewelleries.
func (o *Category) AddJewelleries(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Jewellery) error {
	var err error
	for _, rel := range related {
		if insert {
			...
			values := []interface{}{o.CategoryID, rel.JewelleryID}
...
func FindCategoryG(ctx context.Context, categoryID string, selectCols ...string) (*Category, error) {
...
func (o *Category) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to upsert categories")
	}
...
func (o *Category) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("boiler: no Category provided for reload")
	}
...
func (o *CategorySlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("boiler: empty CategorySlice provided for reload all")
	}
...
func CategoryExistsG(ctx context.Context, categoryID string) (bool, error) {
