...
type AccountAdmin struct {
	AccountAdminsID    string             `boil:"account_admins_id" json:"accountAdminsID" toml:"accountAdminsID" yaml:"accountAdminsID"`
...
var AccountAdminColumns = struct {
	...
	AccountAdminsID:    "account_admins_id",
	Mail:               "mail",
	Password:           "password",
...
var AccountAdminTableColumns = struct {
	...
	AccountAdminsID:    "account_admins.account_admins_id",
...
var AccountAdminWhere = struct {
	AccountAdminsID    whereHelperstring
	...
	AccountAdminsID:    whereHelperstring{field: "\"account_admins\".\"account_admins_id\""},
	Mail:               whereHelpernull_String{field: "\"account_admins\".\"mail\""},
...
var (
	accountAdminAllColumns            = []string{"account_admins_id", "mail", "password", "account_admin_role", "account_admin_status", "created_at", "updated_at"}
	accountAdminColumnsWithoutDefault = []string{"password", "account_admin_role", "account_admin_status"}
	accountAdminColumnsWithDefault    = []string{"account_admins_id", "mail", "created_at", "updated_at"}
	accountAdminPrimaryKeyColumns     = []string{"account_admins_id"}
...
func (q accountAdminQuery) One(ctx context.Context, exec boil.ContextExecutor) (*AccountAdmin, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "boiler: failed to execute a one query for account_admins")
	}
...
func (q accountAdminQuery) All(ctx context.Context, exec boil.ContextExecutor) (AccountAdminSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "boiler: failed to assign all query results to AccountAdmin slice")
	}
...
func (q accountAdminQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to count account_admins rows")
	}
...
func (q accountAdminQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "boiler: failed to check if account_admins exists")
	}
...
func FindAccountAdminG(ctx context.Context, accountAdminsID string, selectCols ...string) (*AccountAdmin, error) {
	return FindAccountAdmin(ctx, boil.GetContextDB(), accountAdminsID, selectCols...)
}

// FindAccountAdmin retrieves a single record by ID with an executor.
// If selectCols is empty Find will return all columns.
func FindAccountAdmin(ctx context.Context, exec boil.ContextExecutor, accountAdminsID string, selectCols ...string) (*AccountAdmin, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"account_admins\" where \"account_admins_id\"=$1", sel,
	)

	q := queries.Raw(query, accountAdminsID)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "boiler: unable to select from account_admins")
	}
...
func (o *AccountAdmin) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("boiler: no account_admins provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to insert into account_admins")
	}
...
func (o *AccountAdmin) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("boiler: unable to update account_admins, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to update account_admins row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to get rows affected by update for account_admins")
	}
...
func (q accountAdminQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to update all for account_admins")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to retrieve rows affected for account_admins")
	}
...
func (o AccountAdminSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to update all in accountAdmin slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to retrieve rows affected all in update all accountAdmin")
	}
	return rowsAff, nil
}
...
func (o *AccountAdmin) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("boiler: no account_admins provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("boiler: unable to upsert account_admins, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to upsert account_admins")
	}
...
func (o *AccountAdmin) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("boiler: no AccountAdmin provided for delete")
	}
	...
	sql := "DELETE FROM \"account_admins\" WHERE \"account_admins_id\"=$1"
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to delete from account_admins")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to get rows affected by delete for account_admins")
	}
...
func (q accountAdminQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("boiler: no accountAdminQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to delete all from account_admins")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to get rows affected by deleteall for account_admins")
	}
...
func (o AccountAdminSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to delete all from accountAdmin slice")
	}
...
func (o *AccountAdmin) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("boiler: no AccountAdmin provided for reload")
	}
...
func (o *AccountAdmin) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindAccountAdmin(ctx, exec, o.AccountAdminsID)
	if err != nil {
		return err
	}
...
func (o *AccountAdminSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("boiler: empty AccountAdminSlice provided for reload all")
	}
...
func (o *AccountAdminSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to reload all in AccountAdminSlice")
	}
...
func AccountAdminExistsG(ctx context.Context, accountAdminsID string) (bool, error) {
	return AccountAdminExists(ctx, boil.GetContextDB(), accountAdminsID)
}

// AccountAdminExists checks if the AccountAdmin row exists.
func AccountAdminExists(ctx context.Context, exec boil.ContextExecutor, accountAdminsID string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"account_admins\" where \"account_admins_id\"=$1 limit 1)"

	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, sql)
		fmt.Fprintln(writer, accountAdminsID)
	}
	row := exec.QueryRowContext(ctx, sql, accountAdminsID)

	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "boiler: unable to check if account_admins exists")
	}
...
func (o *AccountAdmin) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return AccountAdminExists(ctx, exec, o.AccountAdminsID)
}
